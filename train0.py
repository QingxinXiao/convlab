...
if __name__ == '__main__':
    ...
    parser.add_argument("--batchsz", type=int, default=16, help="batch size of trajactory sampling")
    ...
    print("torch seed ----------------------------{}".format(args.torch_seed))
    print("batchsize-----------------------------{}".format(args.batchsz))
